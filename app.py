...
def main():
    ...
    parser.add_argument('--input', default='default_input.txt', help='Path to input file')
    parser.add_argument('--output', default='default_input.txt', help='Path to output file')
    parser.add_argument('--verbose', default='default_input.txt', help='Enable verbose mode')
    ...
    project = "phi2-finetune-with-doc-with-end-1"
